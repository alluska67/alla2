<?php if(isset($_SESSION['user']) && $_SESSION['user']['access'] != 5) { ?>
  <div class="all_news_inside">
    ...
    <a class="btn btn-success" href="/admin/authors/add">Добавить автора</a>
      <h2 class="text-primary border  h2_right_news" >Всего авторов <?=count($authors);?>:</h2>
            ...
            <div class="row no-gutters">
              ...
              <div class="col-md-9">
                <div class="card-body">
                  ...
                  <p class="card-text"><small class="p-1 mb-2 bg-light "><?=htmlspecialchars($author['years_of_life']) ;?> </small></p><br>
                  <p class="card-text"><?=htmlspecialchars(mb_strimwidth($author['biography'], 0, 200,'...')); ?></p>
                    <p>Произведения автора:</p>
                  <?php foreach ($author['book'] as $k=>$book) { ;?>
