        ...
        <?php foreach ($books as $k=> $book) { ;?>
          <div class="card mb-12 border border-secondary news_content">
            <div class="row no-gutters">
              ...
              <div class="col-md-9">
                <div class="card-body">
                  <p class="card-text"><small class="p-1 mb-2 bg-info text-white"><?=htmlspecialchars($book['date']) ;?></small></p><br>
                    <?php foreach ($book['author'] as $k=>$author) { ;?>
                        <a href="/books/show?action=show&author=<?=htmlspecialchars($k); ?>"><?=htmlspecialchars($author) ;?></a><br>
                    <?php }?>
                  <h5 class="card-title"><?=htmlspecialchars(mb_strimwidth($book['title'], 0, 100,'...')); ?></h5>
